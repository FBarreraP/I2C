...
void main(void) {
    ...
    WriteI2C(0x4E,0x04);
    WriteI2C(0x4E,(0x04&~0x04));
    WriteI2C(0x4E,0x24);
    WriteI2C(0x4E,(0x24&~0x04));

    WriteI2C(0x4E,0x04);
    WriteI2C(0x4E,(0x04&~0x04));
    WriteI2C(0x4E,0x64);
    WriteI2C(0x4E,(0x64&~0x04));

    WriteI2C(0x4E,0x04);
    WriteI2C(0x4E,(0x04&~0x04));
    WriteI2C(0x4E,0xF4);
    WriteI2C(0x4E,(0xF4&~0x04));

    WriteI2C(0x4E,0x24);
    WriteI2C(0x4E,(0x24&~0x04));
    WriteI2C(0x4E,0x84);
    WriteI2C(0x4E,(0x84&~0x04));

    WriteI2C(0x4E,0x04);
    WriteI2C(0x4E,(0x04&~0x04));
    WriteI2C(0x4E,0x14);
    WriteI2C(0x4E,(0x14&~0x04));

    WriteI2C(0x4E,0x45);
    WriteI2C(0x4E,(0x45&~0x04));
    WriteI2C(0x4E,0x65);
    WriteI2C(0x4E,(0x65&~0x04));

    WriteI2C(0x4E,0x04);
    WriteI2C(0x4E,(0x04&~0x04));
    WriteI2C(0x4E,0xE4);
    WriteI2C(0x4E,(0xE4&~0x04));
    while(1){
...
void ReadI2C(unsigned char Address, unsigned char Register, unsigned char *Data, int bytes){
    ...
    StopI2C();
    _delay((unsigned long)((10*100)*(8000000/4000.0)));
}
